  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday:
          "text-muted-foreground rounded-md w-9 font-medium text-[0.8rem] text-center flex items-center justify-center h-9",
        week: "flex w-full mt-2 justify-between",
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 flex items-center justify-center rounded-xl transition-all"
        ),
        ...
        today: "bg-accent text-accent-foreground font-bold ring-2 ring-primary/20",
        outside:
